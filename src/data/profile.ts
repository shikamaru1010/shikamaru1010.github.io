export const profile = {
  ...
  linkedin: 'https://www.linkedin.com/in/ratko-sisovic',
  linkedinHandle: 'ratko-sisovic',
  ...
  about: [
    ...
    "I'm in my third year of Information Systems & Technologies at FON (University of Belgrade), where I've built strong fundamentals in software design, databases, computer networks (TCP/IP, Wireshark, sockets) and optimization — and I pair that with a lot of hands-on building outside the curriculum.",
