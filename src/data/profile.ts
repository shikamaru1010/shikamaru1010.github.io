export const profile = {
  ...
  status: 'Software Engineering Intern @ Podyx · Open to future opportunities',
  ...
  about: [
    ...
    "Currently I'm a Software Engineering Intern at Podyx — a SaaS platform for podcast and creative studio management — contributing to a production codebase in a real team workflow. Across that, personal projects and freelance client work I own the whole loop: understanding the problem, designing and shipping it, then keeping it healthy in production. I like roles where technical depth meets clear communication and making complex things run smoothly.",
  ],

  // Three-sentence elevator pitch — copied to clipboard by the "Copy pitch" button.
  pitch:
    "I'm Ratko Šišović, a 3rd-year Information Systems student at FON (Belgrade), currently a Software Engineering Intern at Podyx (SaaS for podcast studio management) and a software developer working across full-stack web, mobile, and Python automation/AI. I've built and operated production-grade systems — an AI trading agent with live dashboards and risk guardrails, an AI mobile companion app, developer observability tooling, and internal business systems for real clients. I'm looking for roles where I can combine strong fundamentals with hands-on delivery and genuine ownership.",
};
